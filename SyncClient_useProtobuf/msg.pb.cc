...
PROTOBUF_CONSTEXPR MsgData::MsgData(
    ...
    /*decltype(_impl_.dara_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::MsgData, _impl_.dara_),
};
...
MsgData::MsgData(const MsgData& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.dara_){}
    , decltype(_impl_.id_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.dara_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.dara_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_dara().empty()) {
    _this->_impl_.dara_.Set(from._internal_dara(), 
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_dara();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "MsgData.dara"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* MsgData::_InternalSerialize(
  ...
  // string dara = 2;
  if (!this->_internal_dara().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_dara().data(), static_cast<int>(this->_internal_dara().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "MsgData.dara");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_dara(), target);
  }
...
void MsgData::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_dara().empty()) {
    _this->_internal_set_dara(from._internal_dara());
  }
...
void MsgData::InternalSwap(MsgData* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.dara_, lhs_arena,
      &other->_impl_.dara_, rhs_arena
  );
